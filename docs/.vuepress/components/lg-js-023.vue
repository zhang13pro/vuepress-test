  ...
  <div data-v-1605a430="">
        ...
        <div data-v-6ecd2302="" class="media-container">
          ...
          <div data-v-6ecd2302="" class="data-wrap inline-block">
            ...
            <div data-v-6ecd2302="" class="detail-wrap">
              <div data-v-6ecd2302="" class="detail-one">19.15M</div>
              <div data-v-6ecd2302="" class="detail-two">00:00/07:20</div>
            </div>
          </div>
    ...
    <div data-v-1605a430="" class="main-container">
      <div data-v-1605a430="" class="rich-text-wrap">
        ...
        <p data-nodeid="3290">
          无论你是否处于求职阶段，都一定要对自己的职业规划有一个清晰的定位。因此，对于目标公司的选人标准你首先要搞清楚，这样才能有的放矢。如果你的目标是互联网大厂核心业务的前端岗位，那么首先你要找到这个部门招聘的
          JD，去研究该部门对前端岗位的要求是什么样的。比如有些部门的诉求是精通
          Node.js，另外一些部门要求有前端可视化经验，这里的确会根据每个部门的实际情况而定。
        </p>
        <p data-nodeid="3291">一起来看看某个一线大厂的前端岗位 JD。</p>
        <p data-nodeid="3292">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/40/CioPOWBZhMmAey6FAABsTSE2Xzc783.png"
            alt="Drawing 0.png"
            data-nodeid="3354"
          />
        </p>
        <p data-nodeid="3293">
          从上面的 JD
          可以基本看出，这个职位需要候选人有跨端的经验，因此在面试之前你需要对前端动态化相关内容（RN、Weex
          等）有一定了解，并且根据你自身的情况看是否匹配。另外，从这个 JD
          可以明显看出，该职位做的是面向用户（toC）产品的业务，因为要求你对性能优化以及浏览器兼容问题有一定的理解。
        </p>
        <p data-nodeid="3294">
          因此在投递该职位的时候，如果你的技能
          80%与之匹配，那么关于用人单位关注的这些点，你最好在简历中突出体现，这就不得不说简历的写法了，下面一起看看大厂都喜欢关注简历的哪些条件。
        </p>
        ...
        <p data-nodeid="3307">
          <strong data-nodeid="3380">注意千万不能有这个想法</strong
          >：项目中有一个很有技术含量的东西，但不是你实现的，你也完全不了解，就想写进项目里。
        </p>
        <p data-nodeid="3308">
          <strong data-nodeid="3386">3. 有亮点的</strong>
        </p>
        <p data-nodeid="3309">
        ...
        <p data-nodeid="3319">
          <strong data-nodeid="3395"
            >总结一下：项目经历一定是面试官比较关心的部分，面试中一定会细问，所以切记不要啰唆，挑有挑战的、有意思的东西写，并且自己能讲明白的。</strong
          >
        </p>
        <p data-nodeid="3320">接下来还有重要的一环就是专业技能。</p>
        <p data-nodeid="3321">
          专业技能这部分很多人会这样写：精通 HTML/CSS/JavaScript
          等，而且写得特别多，恨不得把自己用过的东西都写在这。
        </p>
        <p data-nodeid="3322">
          我个人建议这里不要写太多东西，而是可以写一些在项目经历里没提到的东西。举个例子，如果我的项目经历主要以
          Vue 业务开发为主，我在这里就写 TypeScript/React/工程化/Node/MySQL
          相关的，一些更细节化的东西会让面试官更全面地了解你。
        </p>
        <p data-nodeid="3323">
        ...
        <p data-nodeid="3807">
          <strong data-nodeid="3812">1.JavaScript 相关知识</strong>
        </p>
        <p data-nodeid="3808" class="">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/27/BD/CioPOWBdqTKABzwkAAS4O8a6zdg605.png"
            alt="替换1.png"
            data-nodeid="3815"
          />
        </p>
        ...
        <p data-nodeid="3330">
          <strong data-nodeid="3414">2.CSS 相关知识</strong>
        </p>
        <p data-nodeid="3331" class="te-preview-highlight">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/79/CioPOWBZvCKARqbwAAcG8s48n48724.png"
            alt="图片2.png"
            data-nodeid="3417"
          />
        </p>
        <p data-nodeid="3332">
          <strong data-nodeid="3421">3.前端框架相关知识</strong>
        </p>
        <p data-nodeid="3333">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/7C/Cgp9HWBZvCmARl8TAAJGsoqNml4712.png"
            alt="图片3.png"
            data-nodeid="3424"
          />
        </p>
        <p data-nodeid="3334">
          <strong data-nodeid="3428">4.工程化相关知识</strong>
        </p>
        <p data-nodeid="3335">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/79/CioPOWBZvC-ADmXKAAaltQiapR0682.png"
            alt="图片4 (1).png"
            data-nodeid="3431"
          />
        </p>
        <p data-nodeid="3336">
          <strong data-nodeid="3435">5.性能优化相关知识</strong>
        </p>
        <p data-nodeid="3337">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/7C/Cgp9HWBZvDqAbhRGAAOV9UkSVcc273.png"
            alt="图片5.png"
            data-nodeid="3438"
          />
        </p>
        <p data-nodeid="3338">
          <strong data-nodeid="3442">6.计算机网络相关知识</strong>
        </p>
        <p data-nodeid="3339">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/79/CioPOWBZvEKAS-KyAAh_BgalLrE159.png"
            alt="图片6.png"
            data-nodeid="3445"
          />
        </p>
        <p data-nodeid="3340">
          <strong data-nodeid="3449">7.前端安全相关知识</strong>
        </p>
        <p data-nodeid="3341">
          <img
            src="https://s0.lgstatic.com/i/image6/M00/25/7C/Cgp9HWBZvEiAAd_BAAPw1O2oa_U241.png"
            alt="图片7.png"
            data-nodeid="3452"
          />
        </p>
        ...
        <p data-nodeid="3343">
          另外，前端知识体系比较广并且发展迅速，我们一定要铭记：<strong
            data-nodeid="3459"
            >基础知识是很重要的</strong
          >，把基础能力打牢，才能以不变应万变。
        </p>
