  ...
  <div data-v-1605a430="">
        ...
        <div data-v-6ecd2302="" class="media-container">
          ...
          <div data-v-6ecd2302="" class="data-wrap inline-block">
            ...
            <div data-v-6ecd2302="" class="detail-wrap">
              <div data-v-6ecd2302="" class="detail-one">23.07M</div>
              <div data-v-6ecd2302="" class="detail-two">00:00/08:50</div>
            </div>
          </div>
    ...
    <div data-v-1605a430="" class="main-container">
      <div data-v-1605a430="" class="rich-text-wrap">
        <p data-nodeid="38120">
          这一讲，我们将从最基本的语法、原始类型层面的知识点正式开启 TypeScript
        ...
        <blockquote data-nodeid="39530">
          <p data-nodeid="39531" class="">
            ...
            IDE（可以回顾一下“01 | 如何快速搭建 TypeScript 开发环境？”的内容）
        ...
        <p data-nodeid="38124">
          TypeScript 其实就是类型化的 JavaScript，它不仅支持 JavaScript
          的所有特性，还在 JavaScript 的基础上添加了静态类型注解扩展。
        </p>
        <p data-nodeid="38125">
          这里我们举个例子来说明一下，比如 JavaScript 中虽然提供了原始数据类型
        ...
        <p data-nodeid="38137">
          而 TypeScript 语法与 JavaScript 语法的区别在于，我们可以在 TypeScript
          中显式声明变量<code data-backticks="1" data-nodeid="38254">num</code
          >仅仅是数字类型，也就是说只需在变量<code
            data-backticks="1"
            data-nodeid="38256"
            >num</code
          >后添加<code data-backticks="1" data-nodeid="38258">: number</code
          >类型注解即可，如下代码所示：
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
        ...
        <p data-nodeid="38139">
          ...
          >表示数字类型，<code data-backticks="1" data-nodeid="38265">:</code
          >用<strong data-nodeid="38271">来分割变量和类型的分隔符。</strong>
        </p>
        <p data-nodeid="38140">
          同理，我们也可以把<code data-backticks="1" data-nodeid="38273">:</code
          >后的<code data-backticks="1" data-nodeid="38275">number</code
          >换成其他的类型（比如 JavaScript
          原始类型：number、string、boolean、null、undefined、symbol
          等），此时，num 变量也就拥有了 TypeScript 同名的原始类型定义。
        </p>
        <p data-nodeid="38141">
        ...
        <p data-nodeid="42246" class="">
          在 JavaScript 中，原始类型指的是非对象且没有方法的数据类型，它包括
          string、number、bigint、boolean、undefined 和 symbol 这六种
        ...
        <p data-nodeid="38176">
          在 JavaScript 语言中，原始类型值是最底层的实现，对应到 TypeScript
          中同样也是最底层的类型。
        </p>
        <p data-nodeid="38177">
          为了实现更合理的逻辑边界，本专栏我们把以上原始类型拆分为基础类型和特殊类型这两部分进行讲解。02
          讲主要讲解字符串、数字（包括 number 和 bigint）、布尔值、Symbol 这 4
          种基础类型，03 讲主要讲解 null 和 undefined 等特殊字符。
        </p>
        ...
        <p data-nodeid="38179">
          在 JavaScript 中，我们可以使用<code
            ...
            data-nodeid="38312"
            >string</code
          >表示 JavaScript 中任意的字符串（包括模板字符串），具体示例如下所示：
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
            <div class="copy-icon"></div>
        ...
        <blockquote data-nodeid="38181">
          <p data-nodeid="38182">
            <strong data-nodeid="38317"
              >说明：所有 JavaScript 支持的定义字符串的方法，我们都可以直接在
              TypeScript 中使用。</strong
            >
          </p>
        </blockquote>
        <h4 data-nodeid="38183">数字</h4>
        <p data-nodeid="38184">
          同样，我们可以使用<code data-backticks="1" data-nodeid="38320"
            >number</code
          >类型表示 JavaScript
        ...
        <p data-nodeid="38188">
          ...
          ><code data-backticks="1" data-nodeid="38328">number</code>和<code
            data-backticks="1"
            data-nodeid="38330"
            >bigint</code
          >都表示数字，但是这两个类型不兼容。
        ...
        <p data-nodeid="38189">
          ...
          中输入如下示例，问题面板中将会抛出一个类型不兼容的 ts(2322) 错误。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
            <div class="copy-icon"></div>
        ...
        <p data-nodeid="38192">
          同样，我们可以使用<code data-backticks="1" data-nodeid="38336"
            >boolean</code
        ...
        <p data-nodeid="38195">
          自 ECMAScript 6 起，TypeScript 开始支持新的<code
            ...
            data-nodeid="38340"
            >Symbol</code
          >原始类型， 即我们可以通过<code data-backticks="1" data-nodeid="38342"
            >Symbol</code
        ...
        <p data-nodeid="38201">
          ...
          类型，因为它们并没有什么特殊的用途。这就像我们不必使用 JavaScript
        ...
        <p data-nodeid="38204">
          ...
          中是等价的，这得益于基于上下文的类型推导（这部分内容我们将在 04
          讲中详细说明）。
        </p>
        <p data-nodeid="38205">
        ...
        <p data-nodeid="38207">
          此时，我们可以看到 VS Code 的内容和问题面板区域提示了错误（其他 IDE
          也会出现类似提示），如下图所示：
        </p>
        ...
        <p data-nodeid="38218">
          而如果我们声明了一个<code data-backticks="1" data-nodeid="38378"
            >string</code
          >类型的变量<code data-backticks="1" data-nodeid="38380">fakeNum</code
        ...
        <p data-nodeid="38219">
          实际上，正如 01 讲提到，TypeScript 的语言服务可以和 VS Code
          完美集成。<strong data-nodeid="38392"
        ...
        <p data-nodeid="38222" class="">
          这一讲通过与 JavaScript 的基础类型进行对比，我们得知：TypeScript
          其实就是添加了类型注解的
          JavaScript，它并没有任何颠覆性的变动。因此，学习并掌握 TypeScript
          一定会是一件极其容易的事情。
        </p>
        <p data-nodeid="38223">
