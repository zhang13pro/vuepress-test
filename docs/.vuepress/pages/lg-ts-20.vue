  ...
  <div data-v-1605a430="">
        ...
        <div data-v-6ecd2302="" class="media-container">
          ...
          <div data-v-6ecd2302="" class="data-wrap inline-block">
            ...
            <div data-v-6ecd2302="" class="detail-wrap">
              <div data-v-6ecd2302="" class="detail-one">41.13M</div>
              <div data-v-6ecd2302="" class="detail-two">00:00/15:46</div>
            </div>
          </div>
    ...
    <div data-v-1605a430="" class="main-container">
      <div data-v-1605a430="" class="rich-text-wrap">
        ...
        <p data-nodeid="24479">
          然而，TypeScript 作为 JavaScript 的超集，花费了漫长的时间才替代了
          JavaScript，并成长为构建应用的主流技术。比如我自己所负责的项目，最初也主要是基于
          ES6（JavaScript） 源码构建的，甚至极个别项目是基于无须转译的
          ES5（JavaScript） 代码构建的。
        </p>
        <p data-nodeid="24480">
          从 JavaScript 进化到
          TypeScript，也就意味着需要大量的迁移、重构操作。因此，接下来我们将学习将
          JavaScript 技术栈项目迁移到 TypeScript 的操作步骤和实用技巧。
        </p>
        <h3 data-nodeid="24481">迁移步骤</h3>
        <h4 data-nodeid="24482">调整项目结构</h4>
        <p data-nodeid="24483">
          首先，我们可以参照 18 讲和 19 讲的内容调整项目结构，比如使用 src
          目录组织源码，typings 目录组织类型声明定义，lib 目录作为 Node.js
        ...
        <p data-nodeid="24485">
          因为如今大多数的 JavaScript 项目都是基于 ES6+ 组织源码，再转译为
        ...
        <ul data-nodeid="29679">
          ...
          <li data-nodeid="29684">
            <p data-nodeid="29685">
              第 20 行我们把 typings 目录添加到类型查找路径，让 TypeScript
        ...
        <blockquote data-nodeid="24506">
          <p data-nodeid="24507">
            ...
            TypeScript，所以我们无需配置 rootDir、outDir，甚至可以开启 noEmit
            配置（如上边配置第 18 行所示，开启该配置 tsc 不会生成转译产物）。
          </p>
        </blockquote>
        <p data-nodeid="24508">
        ...
        <p data-nodeid="24511">
          ...
          i -D @types/模块名”进行安装）以及需要用来加载并转译 TypeScript 代码的
          Webpack Loader。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
        ...
        <p data-nodeid="24515">
          ...
          文件后缀名，是为了让 Webpack 在解析模块的时候同时识别 TypeScript
          文件。
        </p>
        ...
        <p data-nodeid="24518">
          然后，我们在 17~19 行的 rules 配置中添加了 ts-loader，是为了让 Webpack
          使用 ts-loader 加载和转译 .ts、.tsx 文件。
        </p>
        <blockquote data-nodeid="30763">
          <p data-nodeid="30764">
            一个比较好的实践是，我们可以开启 ts-loader 的 transpileOnly 配置，让
            ts-loader 在处理 TypeScript
        ...
        <p data-nodeid="24523">
          最后，我们在第 22 行引入了 fork-ts-checker-webpack-plugin 专门对
          TypeScript
        ...
        <p data-nodeid="24528">
          具体操作：首先，我们可以通过如下命令安装处理 TypeScript 的 babel
          preset。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
        ...
        <blockquote data-nodeid="24530">
          <p data-nodeid="24531">
            <strong data-nodeid="24657"
              ...
              babel-loader，只需确保 babel-loader 的版本号大于 7 即可。</strong
            >
          </p>
        </blockquote>
        <p data-nodeid="24532">
        ...
        <div class="course-code-area">
          ...
          <pre><code data-language="javascript"><ol><li><div class="code-word"><span class="hljs-built_in">module</span>.exports = {
</div></li><li><div class="code-word">  &ZeroWidthSpace;<span class="hljs-comment">// 其他配置 ...</span>
</div></li><li><div class="code-word">  &ZeroWidthSpace;resolve: 
</div></li><li><div class="code-word">    &ZeroWidthSpace;extensions: [<span class="hljs-string">".ts"</span>, <span class="hljs-string">".tsx"</span>, <span class="hljs-string">".js"</span>, <span class="hljs-string">".jsx"</span>, <span class="hljs-string">".json"</span>]
</div></li><li><div class="code-word">  &ZeroWidthSpace;},
</div></li><li><div class="code-word">  &ZeroWidthSpace;<span class="hljs-built_in">module</span>: {
</div></li><li><div class="code-word">    &ZeroWidthSpace;rules: [
</div></li><li><div class="code-word">      {
        ...
        <p data-nodeid="24534">
          在以上配置中的第 4 行、第 9 行，我们配置并使用了 babel-loader 来转换
          .ts、.tsx 文件。
        </p>
        <p data-nodeid="24535">
        ...
        <blockquote data-nodeid="24537">
          <p data-nodeid="24538">
            注意：因为每个项目中使用的模板不同，所以 babel 配置项可能在
            .babelrc、babel.config.js 单独的配置文件中或者内置在 package.json
            中。
          </p>
        </blockquote>
        <p data-nodeid="24539">
        ...
        <p data-nodeid="24544">
          为什么形容为“愚公移山”？因为将 JavaScript 迁移到 TypeScript
          是一项个<strong data-nodeid="24671"
            >没有太大技术含量的体力活，同时也是一项长久、渐进的过程</strong
          >。
        </p>
        <p data-nodeid="24545">
          迁移 JavaScript 代码的具体操作：首先，我们需要逐个将 .js 文件重名为
          .ts、.jsx 文件重名为 .tsx，比如将项目的主入口文件 index.js 改成
        ...
        <p data-nodeid="24547">
          如果我们希望前期始于一个比较高且好的起点，比如在 tsconfig.json 中配置
          noImplicitAny 为 true（禁用隐式 any），这样就会提示更多的类型错误。
        </p>
        <blockquote data-nodeid="24548">
          <p data-nodeid="24549">
            注意：作为过来人，建议你在 tsconfig.json 的配置上一步到位开启 strict
        ...
        <p data-nodeid="24551">
          ...
          讲中介绍的较为常见的错误和分析），逐个解决迁移后的 TypeScript
          文件中的各种类型错误。
        </p>
        ...
        <p data-nodeid="24557">
          ...
          模块缺少类型声明问题的，首先我们需要频繁使用 declare module
          补齐类型声明。然后，我们将各种补齐类型声明的文件统一放在 typings
          目录中，比如示例 1 中自定义的 jQuery.d.ts（注意：DefinitelyTyped 有
          jQuery 类型定义），示例 2 中声明的静态资源 svg、png、jpg、gif
          文件模块的 images.d.ts。
        </p>
        ...
        <p data-nodeid="24562">
          关于全局变量、属性缺少类型定义的错误，我们也可以使用 declare
          或者扩充相应的接口类型进行解决。
        </p>
        <p data-nodeid="24563">
        ...
        <p data-nodeid="24565">
          在示例中的第 1 行，我们声明了全局变量 $，从而解决了找不到 $ 的
          ts(2581) 错误。在第 2~4 行，我们扩充了 Window 接口，从而解决了访问
          window.<strong data-nodeid="24698">REDUX_DEVTOOLS_EXTENSION</strong>
          时提示属性不存在的 ts(2339) 错误。然后在第 5 到第 9 行，我们扩充了
          NodeModule 接口，从而解决了调用 module.hot.accept 方法时提示的
          ts(2339) 错误。
        </p>
        ...
        <p data-nodeid="24571">
          ...
          05 讲的知识（比如可选参数、剩余参数函数和函数重载）将会得心应手。
        </p>
        <blockquote data-nodeid="24572">
          <p data-nodeid="24573">
            一个好的实践建议：如果我们确实需要暂时使用万金油类型 any
            来绕过静态类型检测，则可以声明一个具有特殊含义的全局类型 AnyToFix
            来代替 any。比如我们可以在 global.d.ts 内添加如下所示的 AnyToFix
            类型别名定义。
          </p>
        </blockquote>
        <div class="course-code-area">
        ...
        <p data-nodeid="24575">
          这样，我们就可以在任何地方使用 AnyToFix 替代 any ，比如下图中的 func
          函数参数 arg 的类型就是
          AnyToFix。并且在条件成熟时，我们可以很方便地筛选出需要类型重构的 func
          函数，然后将其参数类型修改为更明确的类型。
        </p>
        ...
        <p data-nodeid="24579">
          如下示例第 1~3
          行所示，我们习惯先定义一个空对象，再动态添加属性，迁移到 TypeScript
          后就会提示一个对象上属性不存在的 ts(2339) 错误 。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
            <div class="copy-icon"></div>
        ...
        <p data-nodeid="24590">
          在示例中的第 7 行，因为我们使用了 // @ts-ignore 注释强行关闭第 8
          行的静态类型检测，所以第 8 行并不会提示 ts(2345) 错误。
        </p>
        <p data-nodeid="24591">
          另外，我们还可以使用 // @ts-nocheck
          注释强制关闭整个文件静态类型检测。<strong data-nodeid="24725"
            >不过，我建议任何时候都不要使用这个注释。</strong
          >
        </p>
        <p data-nodeid="24592">
          另外一个有用的坏习惯是双重类型断言，即先把源类型值断言为 unknown，再把
          unknown 断言为目标类型。比如上边使用 // @ts-ignore
        ...
        <p data-nodeid="24596">
          ...
          JavaScript 文件修改为 TypeScript 文件、将模块引入方式从 ES5 require
          改为 ES 6 import、将参数隐式 any 类型改为显式
        ...
        <p data-nodeid="24597">
          ...
          1 中，JavaScript 函数 mult 经 ts-migrate 自动转换为 TypeScript
          后，如下示例 2 中所示的参数 first、second 以及函数返回值类型都被明确为
          number。
        </p>
