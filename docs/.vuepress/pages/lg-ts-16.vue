        ...
        <div data-v-6ecd2302="" class="media-container">
          ...
          <div data-v-6ecd2302="" class="data-wrap inline-block">
            ...
            <div data-v-6ecd2302="" class="detail-wrap">
              <div data-v-6ecd2302="" class="detail-one">39.82M</div>
              <div data-v-6ecd2302="" class="detail-two">00:00/15:16</div>
            </div>
          </div>
    ...
    <div data-v-1605a430="" class="main-container">
      <div data-v-1605a430="" class="rich-text-wrap">
        ...
        <p data-nodeid="15969">
          ...
          内的配置根据功能可以分为 6 个部分，接下来我们分别介绍一下。
        </p>
        ...
        <p data-nodeid="15974">
          target 的可选值包括<code data-backticks="1" data-nodeid="16131"
            >ES3</code
          >、<code data-backticks="1" data-nodeid="16133">ES5</code>、<code
            data-backticks="1"
            data-nodeid="16135"
            >ES6</code
          >、<code data-backticks="1" data-nodeid="16137">ES7</code>、<code
            data-backticks="1"
            data-nodeid="16139"
            >ES2017</code
          >、<code data-backticks="1" data-nodeid="16141">ES2018</code>、<code
            data-backticks="1"
            data-nodeid="16143"
            >ES2019</code
          >、<code data-backticks="1" data-nodeid="16145">ES2020</code>、<code
            data-backticks="1"
            data-nodeid="16147"
            >ESNext</code
          >这几种。
        ...
        <p data-nodeid="15978">
          ...
          CommonJS；如果 target 的值为 ES6 或者更高，那么 module 的默认值则为
          ES6。
        </p>
        <p data-nodeid="15979">
        ...
        <p data-nodeid="15981">
          ...
          的输出方式。该选项只影响<code data-backticks="1" data-nodeid="16166"
            >.tsx</code
        ...
        <ul data-nodeid="15982">
          <li data-nodeid="15983">
            <p data-nodeid="15984">
              react: 将 jsx 改为等价的对 React.createElement 的调用，并生成 .js
              文件。
            </p>
          </li>
        ...
        <p data-nodeid="15994">
          incremental 选项用来表示是否启动增量编译。incremental 为<code
            data-backticks="1"
            data-nodeid="16182"
            >true</code
        ...
        <p data-nodeid="15996">
          declaration 选项用来表示是否为项目中的 TypeScript 或 JavaScript
          文件生成 .d.ts 文件，这些 .d.ts 文件描述了模块导出的 API 类型。
        </p>
        <p data-nodeid="15997">
          具体的行为你可以在<a
        ...
        <p data-nodeid="16000">
          Source map 文件以 .js.map （或 .jsx.map）文件的形式被生成到与 .js
          文件相对应的同一个目录下。
        </p>
        <p data-nodeid="16001"><strong data-nodeid="16207">lib</strong></p>
        <p data-nodeid="16002">
          在 13 讲中我们介绍过，安装 TypeScript 时会顺带安装一个 lib.d.ts
          声明文件，并且默认包含了 ES5、DOM、WebWorker、ScriptHost 的库定义。
        </p>
        <p data-nodeid="16003">
          lib 配置项允许我们更细粒度地控制代码运行时的库定义文件，比如说 Node.js
          程序，由于并不依赖浏览器环境，因此不需要包含 DOM
          类型定义；而如果需要使用一些最新的、高级 ES 特性，则需要包含 ESNext
          类型。
        </p>
        <p data-nodeid="16004">
          具体的详情你可以在<a
        ...
        <p data-nodeid="16007">
          在迁移 JavaScript 代码时，你可以先暂时关闭一些严格模式的设置。在正式的
        ...
        <ul data-nodeid="16011">
          ...
          <li data-nodeid="16014">
            <p data-nodeid="16015">
              strictNullChecks：更严格地检查 null 和 undefined 类型，比如数组的
              find 方法的返回类型将是更严格的 T | undefined。
            </p>
          </li>
          ...
          <li data-nodeid="16022">
            <p data-nodeid="16023">
              noImplicitAny：禁止隐式 any 类型，需要显式指定类型。TypeScript
        ...
        <blockquote data-nodeid="16026">
          <p data-nodeid="16027">
            ...
            ><code data-backticks="1" data-nodeid="16240">strict</code
            >设置为<code data-backticks="1" data-nodeid="16242">true</code
        ...
        <ul data-nodeid="16030">
          ...
          <li data-nodeid="16037">
            <p data-nodeid="16038">
              <strong data-nodeid="16266">noFallthroughCasesInSwitch</strong
              >：禁止 switch 语句中的穿透的情况。开启 noFallthroughCasesInSwitch
              后，如果 switch 语句的流程分支中没有 break 或 return
              ，则会抛出错误，从而避免了意外的 swtich 判断穿透导致的问题。
            </p>
          </li>
        </ul>
        ...
        <p data-nodeid="16043">
          module 配置值为 AMD、UMD、System、ES6 时，moduleResolution 默认为
          classic，否则为 node。在目前的新代码中，我们一般都是使用
          node，而不使用classic。
        </p>
        <p data-nodeid="16044">
          具体的模块解析策略，你可以查看<a
        ...
        <p data-nodeid="16048">
          paths 指的是路径设置，用来将模块路径重新映射到相对于 baseUrl
          定位的其他路径配置。这里我们可以将 paths 理解为 webpack 的 alias
          别名配置。
        </p>
        ...
        <blockquote data-nodeid="16052">
          <p data-nodeid="16053">
            <strong data-nodeid="16299"
              >注意：因为 paths 中配置的别名仅在类型检测时生效，所以在使用 tsc
        ...
        <p data-nodeid="16063">
          在上述示例中可以看到，手动指定 types 时 ，仅包含了 node、jest、express
          三个 node 模块的类型包。
        </p>
        <p data-nodeid="16064">
          <strong data-nodeid="16323">allowSyntheticDefaultImports</strong>
        </p>
        <p data-nodeid="16065">
        ...
        <p data-nodeid="16068">
          ...
          allowSyntheticDefaultImports 为 true，则可以直接通过 import 导入
          react；但如果设置 allowSyntheticDefaultImports 为 false，则需要通过
          import * as 导入 react。
        </p>
        <p data-nodeid="16069">
        ...
        <p data-nodeid="16071">
          在默认情况下，TypeScript 像 ES6 模块一样对待 CommonJS / AMD /
          UMD，但是此时的 TypeScript 代码转移会导致不符合 ES6
          模块规范。不过，开启 esModuleInterop 后，这些问题都将得到修复。
        </p>
        <p data-nodeid="16072">
        ...
        <p data-nodeid="16074">
          ...
          支持生成符合 JavaScript Source Map 标准的附加文件（即 .map 文件）。
        </p>
        <p data-nodeid="16075">
        ...
        <p data-nodeid="16077">
          sourceRoot<strong data-nodeid="16350">的</strong>取值可以是路径或者
          URL。
        </p>
        ...
        <p data-nodeid="16081">
          开启 inlineSourceMap 选项时，将不会生成 .js.map 文件，而是将 source
          map 文件内容生成内联字符串写入对应的 .js 文件中。虽然这样会生成较大的
          JS 文件，但是在不支持 .map 调试的环境下将会很方便。
        </p>
        <p data-nodeid="16082">
          <strong data-nodeid="16364">inlineSources</strong>
        </p>
        <p data-nodeid="16083">
          开启 inlineSources 选项时，将会把源文件的所有内容生成内联字符串并写入
          source map 中。这个选项的用途和 inlineSourceMap 是一样的。
        </p>
        <h4 data-nodeid="16084">实验选项</h4>
        <p data-nodeid="16085">
          TypeScript 支持一些尚未在 JavaScript 提案中稳定的语言特性，因此在
          TypeScript 中实验选项是作为实验特性存在的。
        </p>
        <p data-nodeid="16086">
          <strong data-nodeid="16371">experimentalDecorators</strong>
        </p>
        <p data-nodeid="16087">
        ...
        <p data-nodeid="16088">
          <strong data-nodeid="16382"
            >目前，装饰器提案在 stage 2 仍未完全批准到 JavaScript 规范中，且
            TypeScript 实现的装饰器版本可能和 JavaScript 有所不同。</strong
          >
        </p>
        <p data-nodeid="16089">
        ...
        <p data-nodeid="16095">
          <strong data-nodeid="16410">forceConsistentCasingInFileNames</strong>
        </p>
        <p data-nodeid="16096">
          TypeScript
        ...
        <p data-nodeid="16099">
          ...
          项目中的文件或者文件匹配路径。如果我们指定了 files 配置项，则 include
          的 默认值为 []，否则 include 默认值为 ["**/*"]
          ，即包含了目录下的所有文件。
        </p>
        <p data-nodeid="16100">
        ...
        <p data-nodeid="16101">
          一般来说，include 的默认值为.ts、.tsx 和 .d.ts。如果我们开启了 allowJs
          选项，还包括 .js 和 .jsx 文件。
        </p>
        <h3 data-nodeid="16102">exclude</h3>
        <p data-nodeid="16103">
          exclude 用来指定解析 include
          配置中需要跳过的文件或者文件匹配路径。一般来说，exclude 的默认值为
        ...
        <blockquote data-nodeid="16104">
          <p data-nodeid="16105">
            <strong data-nodeid="16461">需要注意</strong>：<code
              ...
              data-nodeid="16457"
              >exclude</code
            >配置项只会改变<code data-backticks="1" data-nodeid="16459"
              >include</code
            >配置项中的结果。
          </p>
        </blockquote>
        ...
        <p data-nodeid="16108">
          如果项目非常小，那么我们可以使用 files<strong data-nodeid="16472"
            >指定项目的文件，否则更适合使用</strong
          >include<strong data-nodeid="16473">指定项目文件。</strong>
        </p>
        ...
        <p data-nodeid="16115">
          17 讲我们将介绍解析在 TypeScript 项目开发中常见的类型错误以及如何为
          TypeScript 类型编写单元测试，敬请期待！
        </p>
        <p data-nodeid="16116">
