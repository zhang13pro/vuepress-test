        ...
        <div data-v-6ecd2302="" class="media-container">
          ...
          <div data-v-6ecd2302="" class="data-wrap inline-block">
            ...
            <div data-v-6ecd2302="" class="detail-wrap">
              <div data-v-6ecd2302="" class="detail-one">37.91M</div>
              <div data-v-6ecd2302="" class="detail-two">00:00/14:32</div>
            </div>
          </div>
    ...
    <div data-v-1605a430="" class="main-container">
      <div data-v-1605a430="" class="rich-text-wrap">
        <p data-nodeid="1421" class="">
          ...
          之前，我们有必要先掌握 TypeScript 开发环境的搭建及相关注意事项。
        </p>
        <h3 data-nodeid="1422">IDE for TypeScript</h3>
        <p data-nodeid="1423">
          在搭建 TypeScript 环境之前，我们需要先认识几款适合 TypeScript 的
          IDE。只有这样，在开发时我们才能根据实际情况选择合适的 IDE
          进行安装，从而提升工作效率。
        </p>
        <h4 data-nodeid="1424">VS Code</h4>
        <p data-nodeid="1425">
          如果让我推荐一款 IDE 的话，我会首推微软的“亲儿子”——开源编辑器 VS
          Code（Visual Studio Code），因为它具备以下 4 点优势：
        </p>
        <ol data-nodeid="1426">
          <li data-nodeid="1427">
            <p data-nodeid="1428">
        ...
        <p data-nodeid="1436">
          ...
          目录添加到环境变量 PATH 中，以便更方便地唤起它，如下代码所示：
        </p>
        ...
        <p data-nodeid="1442">
          因为 VS Code 中内置了特定版本的 TypeScript 语言服务，所以它天然支持
          TypeScript 语法解析和类型检测，且这个内置的服务与手动安装的 TypeScript
          完全隔离。因此，<strong data-nodeid="1583"
            >VS Code
        ...
        <p data-nodeid="1443">
          ...
          TypeScript，我们就可以点击 VS Code 底部工具栏的版本号信息，从而实现
          “use VS Code's Version” 和 “use Workspace's Version”
          两者之间的随意切换。
        </p>
        <p data-nodeid="1444">
        ...
        <div data-nodeid="1446">
          <p style="text-align: center">可随意切换 TypeScript 版本窗口图</p>
        </div>
        <p data-nodeid="1447">
          我们也可以在当前应用目录下的 “.VS Code/settings.json”
          内添加命令（如下所示）配置 VS Code 默认使用应用目录下安装的 TypeScript
          版本，以便提供语法解析和类型检测服务。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
        ...
        <div data-nodeid="1451">
          <p style="text-align: center">查看所有的类型错误信息概览图</p>
        </div>
        <p data-nodeid="1452">
        ...
        <div data-nodeid="1461">
          <p style="text-align: center">VS Code 内置的命令行工具图</p>
        </div>
        <p data-nodeid="1462">
        ...
        <p data-nodeid="1468">
          WebStorm 也是基于标准的 TypeScript Language Service 来支持 TypeScript
          的各种特性，与其他 IDE 在类型检测结果、自动完成提示上没有任何差异。
        </p>
        <p data-nodeid="1469">
        ...
        <p data-nodeid="1475">
          因为 WebStorm 毕竟是一款商业化（收钱的）软件，所以它还集成了很多强大的
        ...
        <p data-nodeid="1479">
          ...
          TypeScript，同时还可以方便地选择 TypeScript 版本、配置 tsconfig，并对
          TypeScript 实时静态类型检测、转译输出 JavaScript 和在线执行。
        </p>
        <p data-nodeid="1480">
          而且在体验上，它也一点儿不逊色于任何本地的 IDE，对于刚刚学习
          TypeScript 的我们来说，算是一个不错的选择。
        </p>
        <ul data-nodeid="1481">
          <li data-nodeid="1482">
            <p data-nodeid="1483">
        ...
        <p data-nodeid="1488">
          Playground
          还为我们提供了分享的功能，比如我们可以把学习成果、遇到的难点通过 URL
          的形式分享给他人。
        </p>
        <p data-nodeid="1489">
          不过，<strong data-nodeid="1672"
            >在实际开发业务应用中，我们还是极力推荐使用 VS Code</strong
        ...
        <p data-nodeid="1493">
          ...
          语言服务，不包含转译器，所以我们还需要单独安装 TypeScript。
        </p>
        <p data-nodeid="1494">
          为了方便快速完成一个入门小示例，这里我们推荐通过命令行工具使用 npm
          全局安装 TypeScript。
        </p>
        <p data-nodeid="1495">
        ...
        <p data-nodeid="1497">
          <strong data-nodeid="1691"
            ...
            版本，所以建议你在尝试操作时也安装本课程使用的 TypeScript 版本（比如
            3.9.2、3.9.3……3.9.7）</strong
          >，如下代码所示：
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
        ...
        <p data-nodeid="1499">
          TypeScript 安装完成后，我们输入如下所示命令即可查看当前安装的
          TypeScript 版本。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
        ...
        <p data-nodeid="1503">
          我们也可以通过安装在 Terminal 命令行中直接支持运行 TypeScript
          代码（Node.js 侧代码）的 ts-node 来获得较好的开发体验。
        </p>
        ...
        <p data-nodeid="1506">
          如果你是 Mac 或者 Linux 用户，就极有可能在 npm i -g typescript 中遭遇
          “EACCES: permission denied” 错误，此时我们可以通过以下 4
          种办法进行解决：
        </p>
        <ul data-nodeid="1507">
          <li data-nodeid="1508">
        ...
        <p data-nodeid="1517">
          ...
          的应用目录用来记录学习过程中的各种练习例子，然后使用 VS Code
          即可打开这个应用。
        </p>
        <h3 data-nodeid="1518">编写 Hello World</h3>
        <p data-nodeid="1519">
          我们可以在练习目录下输入“tsc --init”命令快速创建一个 tsconfig.json
          文件，或者在 VS Code 应用窗口新建一个空的 tsconfg.json<strong
            data-nodeid="1721"
        ...
        <p data-nodeid="1521">
          ...
          语言服务如何对当前应用下的 TypeScript 代码进行类型检测。<strong
            data-nodeid="1726"
        ...
        <p data-nodeid="1525">
          ...
          注解直观地告诉我们，这个变量的类型就是
          string。如果你之前使用过其他强类型的语言（比如 Java），就能快速理解
          TypeScript 语法。
        </p>
        <p data-nodeid="1526">
          当然，在当前目录下，我们也可以通过如下代码创建一个同名的 HelloWorld.js
          文件，而这个文件中抹掉了类型注解的 TypeScript 代码。
        </p>
        <div class="course-code-area">
          <div class="copy-btn">
            <div class="copy-icon"></div>
        ...
        <p data-nodeid="1529">
          .ts 文件创建完成后，我们就可以使用 tsc（TypeScript Compiler） 命令将
          .ts 文件转译为 .js 文件。
        </p>
        <p data-nodeid="1530">
          <strong data-nodeid="1735"
            >注意：指定转译的目标文件后，tsc 将忽略当前应用路径下的
            tsconfig.json 配置，因此我们需要通过显式设定如下所示的参数，让 tsc
        ...
        <div data-nodeid="1548">
          <p style="text-align: center">VS Code 问题面板显示效果图</p>
        </div>
        <p data-nodeid="1549">
